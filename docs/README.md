...
- Current durable boundary is documented in `AGENTS.md`: single-person web chat,
  Rust server, provider-abstracted model streaming with concrete OpenAI
  Responses and Chat Completions-compatible implementations, generated OpenAPI
  contracts, and normalized local persistence.
